...
import static org.apache.flink.table.server.cli.CliUtils.TIME_FORMATTER;
import static org.apache.flink.table.server.cli.CliUtils.formatTwoLineHelpOptions;
import static org.apache.flink.table.server.cli.CliUtils.normalizeColumn;
import static org.apache.flink.table.server.cli.CliUtils.repeatChar;
...
public class CliTableResultView extends CliResultView<CliTableResultView.ResultTableOperation> {
	...
	protected void refresh() {
		...
		try {
			result = client.getExecutor().snapshotResult(resultDescriptor.getResultId(), getVisibleMainHeight());
