...
package org.apache.flink.table.server.config;

import org.apache.flink.table.server.SqlClientException;
import org.apache.flink.table.server.config.entries.CatalogEntry;
import org.apache.flink.table.server.config.entries.ConfigurationEntry;
import org.apache.flink.table.server.config.entries.DeploymentEntry;
import org.apache.flink.table.server.config.entries.ExecutionEntry;
import org.apache.flink.table.server.config.entries.FunctionEntry;
import org.apache.flink.table.server.config.entries.TableEntry;
