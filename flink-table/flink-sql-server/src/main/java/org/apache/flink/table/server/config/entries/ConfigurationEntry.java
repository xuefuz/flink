...
package org.apache.flink.table.server.config.entries;

import org.apache.flink.table.descriptors.DescriptorProperties;
import org.apache.flink.table.server.config.ConfigUtil;

import java.util.HashMap;
import java.util.Map;

import static org.apache.flink.table.server.config.Environment.CONFIGURATION_ENTRY;
